...
def mobilenet(pretrained_weights=None, input_size=(224, 224, 3), num_classes=2, learning_rate=1e-3):
...
def resnet50(pretrained_weights=None, input_size=(224, 224, 3), num_classes=2, learning_rate=1e-3):
...
def xception(pretrained_weights=None, input_size=(299, 299, 3), num_classes=2, learning_rate=1e-3):
